   ...
   render(){
     return(
       <form onSubmit={this.handelClick}>
         ...
         <label>GET
           <input className='radioInputs' type='radio' name='GET'  required/>
         </label>
         <label>POST
           <input className='radioInputs' type='radio' name='POST' />
         </label>
         <label> PUT
           <input className='radioInputs' type='radio' name='PUT' />
         </label>
         <label>DELETE
           <input className='radioInputs' type='radio' name='DELETE' />
         </label>
